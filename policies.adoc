...
** *4.2.3.1.* Front Desk PIs should make consistent rounds throughout all benchtops, ensuring the following:
...
* *4.2.5.* Crafts PI Responsibilities
** *4.2.5.1.* PIs on shift for crafts should be sitting in the crafts area when not actively assisting anyone.
** *4.2.5.3.* PIs should ensure that any heat elements (sublimation printer, irons, etc.) are unplugged when not in use.
** *4.2.5.4.* PIs should ensure that any scraps (threads, paper, fabric, etc.) are thrown away or discarded in the appropriate scrap receptacle.
* *4.2.4.* Laser Cutting PI Responsibilities
** *4.2.4.2.* PIs should greet all incoming end users and ask if they need help with anything.
** *4.2.4.3.* End users are welcome to set up cuts themselves, but PIs must verify the settings of every print before it starts. PIs must give the go ahead for every laser cut before an end user presses start.
** *4.2.4.4.* PIs should ensure the floors of the laser cutting room are always clean, especially keeping an eye out for wood scraps and sawdust.
** *4.2.4.5.* At least once per shift, PIs should check the laser cutting room trash can to see if it needs to be emptied and empty it if necessary.
...
** *4.2.5.4.* PIs should remove any finished prints from the printers in the circular room. Gloves must be worn when removing prints, and a plastic scraper may be used on Bambu Labs printers.
** *4.2.5.5.* If a printer has finished but the part is missing, PIs should mark the print as failed.
** *4.2.5.6.* If a printer malfunctions or gives an error, PIs should attempt to fix it or contact and MPI or Staff for assistance.
...
** *4.2.6.5.* If a printer malfunctions or gives an error, PIs should attempt to fix it or contact and MPI or Staff for assistance.
** *4.2.6.6.* PIs should check the resin curing oven at least once per shift for any completed resin prints.
** *4.2.6.7.* PIs should ensure the floors of the semi-clean room are always clean, especially keeping an eye out for loose filament pieces, paper towels, etc. They should sweep and vacuum as necessary.
** *4.2.6.8.* At least once per shift, PIs should check the trash cans in the semi-clean room to see if they need to be emptied and if so empty them.
** *4.2.6.9.* PIs should assist or find another PI to assist any PCB end users who need help.
