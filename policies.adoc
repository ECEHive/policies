...
=== 1.4 Participant Classifications

The following classifications define all individuals who may be present in or interact with the space. All policies in this document are applied based on a person's current classification at the time of the relevant interaction.

* *1.4.1. Staff* — As defined in Sections 1.1.2 and 1.1.3, Staff includes the Director, the Assistant Director, GTAs, UTAs, and any additional individuals designated as Staff by the Director or Assistant Director. Staff hold the highest level of authority in the space and possess all privileges described in this document, in addition to any privileges exclusive to Staff.
* *1.4.2. Master Peer Instructors (MPIs)* — MPIs are active Peer Instructors designated as leaders of a specific technical area, as described in Section 1.6. Two distinct operational states are recognized:
** *1.4.2.1. MPI on Shift*: An MPI who is currently working their scheduled flex hours. On-shift MPIs hold active supervisory authority over their technical area and bear all responsibilities described in Section 4.2.
** *1.4.2.2. MPI not on Shift*: An active MPI who is not currently working scheduled flex hours. An off-shift MPI retains 24/7 access to the space and all MPI authority and privileges—including the ability to issue approvals that are specific to MPIs—but does not bear the on-duty obligations of Section 4.2 unless they elect to assume them.

* *1.4.3. Peer Instructors (PIs)* — Active Peer Instructors are GT-affiliated volunteers who meet all requirements in Section 1.5. Any further use of the term "PI" in this document refers exclusively to active (non-hiatus) PIs unless otherwise stated. Two distinct operational states are recognized:
** *1.4.3.1. PI on Shift*: A PI who is currently working their assigned shift. On-shift PIs bear supervisory responsibility for their assigned area and all on-duty responsibilities described in Section 4.2.
** *1.4.3.2. PI not on Shift*: An active PI who is not currently working a scheduled shift. An off-shift PI retains 24/7 access and all PI privileges, but does not bear the on-duty obligations of Section 4.2 unless they elect to assume a supervisory role. When an off-shift PI voluntarily assumes supervision of an end user or guest, they take on the same supervisory obligations as an on-shift PI for the duration of that supervision.

* *1.4.4. End Users* — An end user is any current member of the Georgia Tech community—including currently enrolled students, employed faculty, employed staff, and recognized affiliates—who possesses a valid, active BuzzCard, and who is present in the space without serving as a Staff member, Executive Board member, MPI, or active PI. End users may use the space during open hours and operate equipment as permitted by the policies in this document.

* *1.4.5. GT Student/Faculty/Staff Guests* — A GT Student/Faculty/Staff Guest is an individual who is, or was recently, a Georgia Tech student, faculty member, staff member, or recognized GT affiliate, but who does not possess a valid, active BuzzCard at the time of their visit, and therefore cannot function as an end user. GT Student/Faculty/Staff Guests must be accompanied by a PI or Staff member at all times while in the space. GT Student/Faculty/Staff Guests may not independently operate any equipment; any equipment use requires explicit Staff approval and must occur under direct PI or Staff supervision. GT Student/Faculty/Staff Guests must be signed into HUMS by the accompanying PI or Staff member upon entering, and signed out upon leaving.

* *1.4.6. Non-GT Visitors* — A Non-GT Visitor is any individual who is not a current student, faculty member, staff member, or recognized affiliate of Georgia Tech. Non-GT Visitors may not operate any equipment under any circumstances without explicit Staff approval. Non-GT Visitors may only be in the space under one of the following conditions: (a) as part of an organized group tour, (b) as a supervised PI guest under Section 4.3.2, or (c) as a registered participant in a Staff-authorized event such as a workshop or outreach event. Non-GT Visitors on organized group tours are exempt from the HUMS sign-in requirement for the duration of the tour; Non-GT Visitors present in any other capacity must be signed into HUMS by the accompanying PI or Staff member.

* *1.4.7. Hiatus Peer Instructors* — PIs on hiatus (as described in Section 1.5.3) retain only the privileges of end users. They do not hold PI-level access, authority, or privileges for any purpose under this document.
...
* *2.2.1.* All those in the space are expected to conduct themselves in an appropriate manner. All participants—including end users, GT Student/Faculty/Staff Guests, Non-GT Visitors, PIs, MPIs, and Staff—are expected to show respect for all people and equipment in the space at all times.
...
* *2.3.1.* End users entering the space must sign into HUMS at one of the terminals in the space. GT Student/Faculty/Staff Guests must be signed into HUMS by the accompanying PI or Staff member upon entering. Non-GT Visitors on organized group tours are exempt from the HUMS sign-in requirement for the duration of the tour; Non-GT Visitors present in any other capacity must be signed into HUMS by the accompanying PI or Staff member.
* *2.3.2.* End users must sign out of HUMS upon leaving the space. GT Student/Faculty/Staff Guests and Non-GT Visitors who were signed into HUMS must likewise be signed out by the accompanying PI or Staff member upon leaving.
* *2.3.3.* End users are required to comply with the instructions of PIs.
* *2.3.4.* End users, GT Student/Faculty/Staff Guests, and Non-GT Visitors may only be in the semi-clean room, laser cutting room, or machine shop if a PI is present and actively supervising them. They must promptly leave the room if asked to by the supervising PI who can no longer supervise the area, regardless of project status.
...
* *2.5.5.* End users, GT Student/Faculty/Staff Guests, and Non-GT Visitors are only permitted to enter the space at the main door on the 2nd floor. GT Student/Faculty/Staff Guests and Non-GT Visitors must be accompanied by a PI or Staff member at all times upon entry. No end user, GT Student/Faculty/Staff Guest, or Non-GT Visitor shall grant entry to anyone through any locked door. PIs may grant entry to end users, GT Student/Faculty/Staff Guests, and Non-GT Visitors from other doors after hours or during open hours on an as-needed basis.
...
* *2.7.2.* End users, GT Student/Faculty/Staff Guests, and Non-GT Visitors are only ever permitted in the space after hours if they are being actively supervised by a PI or Staff member. Please reference Section 4.3.2 for specific rules regarding PI guests.
* *2.7.3.* End users, GT Student/Faculty/Staff Guests, and Non-GT Visitors soliciting, bribing, or pressuring PIs, MPIs, or Staff members for access to or use of the space outside official open hours is strictly prohibited. This restriction applies to individuals who do not already have an established relationship with the PI, MPI, or Staff member, including incoming PIs who have not yet completed required trainings, and does not supersede Section 4.3.2.
...
* *2.7.5.* Certain events at the Hive, such as workshops, take place after hours and are open to end users—and, for events designated as outreach events by Staff, to GT Student/Faculty/Staff Guests and Non-GT Visitors—who have properly registered for the specific event. Individuals in the space after hours who are not participating in an authorized event and are not supervised by a PI are in violation of the policies of this section.

=== 2.8 Workshops

* *2.8.1.* Hive workshops are educational events, usually hosted after-hours, open to a limited number of participants. End users and PIs are eligible to sign up for all workshops. GT Student/Faculty/Staff Guests and Non-GT Visitors may register for workshops only when the specific workshop has been designated by Staff as an outreach event open to such participants.
...
* *4.3.2.* PIs are strictly prohibited from letting non-PIs into the space after hours without actively supervising them for the entirety of their visit. Another PI being in the space does not absolve one from violating this policy. PIs may have a maximum of 5 guests in the space after hours at any one time. The following sign-in rules apply based on guest classification:
** End users present as after-hours PI guests must sign into HUMS as end users using their own BuzzCard.
** GT Student/Faculty/Staff Guests must be signed into HUMS by the accompanying PI on their behalf.
** Non-GT Visitors must be signed into HUMS by the accompanying PI on their behalf. PIs are also expected to inform Staff (via the appropriate channel) prior to, or at the time of, bringing Non-GT Visitors into the space after hours.
+
All guests, regardless of classification, must remain under the PI's active supervision at all times. Supervision means being on the same floor as all guests and maintaining a line of sight to them. Guests are prohibited from restricted areas as described in Section 2.5.1 without PI supervision. PIs are responsible for ensuring all guests comply with the policies applicable to end users. PIs are ultimately responsible for the conduct of their guests and any policy violations those guests commit. Taking a short bathroom or water break is permitted without violating this policy, so long as the PI does not leave the building and no guests are actively using any machinery during the break. Violation of this policy will result in a Level 2 infraction and disciplinary action up to being terminated as a PI.
...
* *5.3.* Level 0 infractions may be issued by any PI to an end user, GT Student/Faculty/Staff Guest, or Non-GT Visitor, and must be reported to Staff. Only MPIs and Staff may issue Level 0 infractions to PIs. Level 1-2 infractions may only be issued by Staff. A record of all infractions will be maintained by Staff.
